...
<p>Each section in the page below allows interaction with one of the endpoints described in the requirements
    document.</p>

<hr>
<h2>Days between two datetimes</h2>

<form id="days-between-datetimes" name="days-between-datetimes" method="POST"
